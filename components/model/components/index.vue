<template>
	<view>
		<agent v-if="itemData.type=='agent'" :item-data="itemData.data"></agent>
		<banner v-else-if="itemData.type=='banner'" :item-data="itemData.data"></banner>
		<haibao v-else-if="itemData.type=='haibao'" :item-data="itemData.data"></haibao>
