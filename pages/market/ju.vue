<template>
	<view class="content">
		...
		<view class="list">
			<!-- 空白页 -->
			<view class="ad">
				<image mode="widthFix" src="https://img.alicdn.com/imgextra/i2/2053469401/TB24ylugpkoBKNjSZFkXXb4tFXa_!!2053469401.png"></image>
			</view>
			<empty v-if="loadingType === 'noMore' && items.length === 0"></empty>
			<goods 
				v-for="(item,index) in items" :key="index" 
				:top="index+1"
				:itemData="item" goodsType="ju" />
	...
	export default {
		...
		methods: {
			...
			loadData(source){
				...
				this.$http.post('/cms/goods/ju', {ipage:this.ipage,cid:cid}).then(res => {
