...
<script>
	...
	export default {
		...
		methods: {
			loadNav(){
				this.$http.post('/app/page/nav', {nav_types:'qiang'}).then(res => {
			...
			loadData(source){
				...
				let query_time = navItem.query_time;
				...
				this.$http.post('/cms/goods/qiang', {ipage:this.ipage,query_time:query_time,sort:'day_sales'}).then(res => {
